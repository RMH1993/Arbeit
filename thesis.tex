...
\title{
	\begin{center}
	Konzeption und Entwicklung einer Versionierungssoftware zur besseren Verwaltung
	von Macro- und SPS-Programmen als Bestandteil der Firmware von
...
\begin{document}
  ...
  %\chapter{theoretischer Teil}  in Versionskontrolle integriert wegen sonst erstellter leerer Seite
  %\include{theoretischer_Teil}
  	  	\include{Versionskontrolle}
  	  	\include{Grund_Einsatzgebiet}
  	  	\include{Ind_Fert}
  	  	\include{AM}
  % \include{kap_analyse}
  % \include{kap_entwurf}
